...
//   // without needing to worry about dealing with events 
...
//       });
//     })
//     // After filtering what you need is to map through
//     // the new, shorter array and render each item
//     .map(item => {
//       const { title, link, id } = item;
//       return (
//         <NavigationSubCategoryLink  //call #4 returns the name and pass:
//           key={id}
//           name={title}
//           link={link} />
//       );
